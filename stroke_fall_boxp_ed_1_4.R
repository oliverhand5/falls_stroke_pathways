...
data_boxplot <- read_csv("boxp_ed_1-4.csv")
...
ggsave('Fall_Injuries_Unknown_ed_all_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Non_Injury_ed_all_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Stroke_Neurological_ed_all_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Injuries_Unknown_ed_day_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Non_Injury_ed_day_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Stroke_Neurological_ed_day_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Injuries_Unknown_ed_night_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Non_Injury_ed_night_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Stroke_Neurological_ed_night_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Injuries_Unknown_ed_weekday_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Non_Injury_ed_weekday_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Stroke_Neurological_ed_weekday_1_4.png', height = 1400, width = 3000, units = "px")
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Injuries_Unknown_ed_weekend_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Non_Injury_ed_weekend_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Stroke_Neurological_ed_weekend_1_4.png', height = 1400, width = 3000, units = "px")
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Injuries_Unknown_ed_winter_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Non_Injury_ed_winter_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Stroke_Neurological_ed_winter_1_4.png', height = 1400, width = 3000, units = "px")
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Injuries_Unknown_ed_not_winter_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Fall_Non_Injury_ed_not_winter_1_4.png', height = 1400, width = 3000, units = "px") 
...
ggplot(data_boxplot %>% 
  ...
  scale_x_discrete(labels = function(Cat) str_wrap(Cat, width = 10)) +
  facet_wrap(vars(County))
ggsave('Stroke_Neurological_ed_not_winter_1_4.png', height = 1400, width = 3000, units = "px")
